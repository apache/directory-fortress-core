...
public class TestUtils extends TestCase
{
    ...
    public static void sleep( int len )
    {
        ...
        {
            int iSleep = len * 1000;
            org.openldap.fortress.util.LogUtil.logIt( TestUtils.class.getName() + ".sleep for len=" + iSleep );
            Thread.currentThread().sleep( iSleep );
        }
        catch ( InterruptedException ie )
        {
     ...
     * @param c2
     */
    public static void assertTemporal( String msg, org.openldap.fortress.util.time.Constraint c1,
        org.openldap.fortress.util.time.Constraint c2 )
    {

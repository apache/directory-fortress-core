...
public class ProcessMenuCommand
{
	...
	final private us.jts.fortress.AccessMgrConsole accessConsole = new us.jts.fortress.AccessMgrConsole();
	final private us.jts.fortress.PolicyMgrConsole policyConsole = new us.jts.fortress.PolicyMgrConsole();
	final private us.jts.fortress.AuditMgrConsole auditConsole = new us.jts.fortress.AuditMgrConsole();
	final private us.jts.fortress.DelegatedAdminMgrConsole delAdminConsole = new us.jts.fortress.DelegatedAdminMgrConsole();
	final private us.jts.fortress.DelegatedReviewMgrConsole delReviewConsole = new us.jts.fortress.DelegatedReviewMgrConsole();
	final private us.jts.fortress.DelegatedAccessMgrConsole delAccessConsole = new us.jts.fortress.DelegatedAccessMgrConsole();
	final private us.jts.fortress.ConfigMgrConsole cfgConsole = new us.jts.fortress.ConfigMgrConsole();

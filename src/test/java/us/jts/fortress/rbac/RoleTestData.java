...
public class RoleTestData extends TestCase
{
    ...
    {
        us.jts.fortress.util.time.Constraint validConstraint = RoleTestData.getRoleConstraint(rle);
    ...
    {
        us.jts.fortress.util.time.Constraint validConstraint = RoleTestData.getRoleConstraint(urle);

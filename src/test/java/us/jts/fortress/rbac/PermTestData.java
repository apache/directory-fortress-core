...
public class PermTestData extends TestCase
{
     ...
     * Test Case TOB4_UPD:
     */
    final static String[][] OBJS_TOB4_UPD = {
        {
            "TOB4_1",           /* NAME_COL */
    ...
    public final static String[][] PSWDMGR_OBJ = {
        {
            "us.jts.fortress.rbac.PwPolicyMgrImpl",
            "ARBAC02 policies", /* DESC_COL */
            "APP0",             /* ORG_COL */
            "TST",              /* TYPE_COL */
            "",                 /* PROPS_COL */
    ...
    public final static String[][] ADMINMGR_OBJ = {
        {
            "us.jts.fortress.rbac.AdminMgrImpl",
            "ARBAC02 policies", /* DESC_COL */
            "APP0",             /* ORG_COL */
            "TST",              /* TYPE_COL */
            "",                 /* PROPS_COL */
    ...
    public final static String[][] DELEGATEDMGR_OBJ = {
         {
             "us.jts.fortress.rbac.DelAdminMgrImpl",
    ...
    public final static String[][] DELEGATEDREVIEWMGR_OBJ = {
         {
             "us.jts.fortress.rbac.DelReviewMgrImpl",
    ...
    public final static String[][] REVIEWMGR_OBJ = {
         {
             "us.jts.fortress.rbac.ReviewMgrImpl",
    ...
    public final static String[][] AUDITMGR_OBJ = {
         {
             "us.jts.fortress.rbac.AuditMgrImpl",
    ...
    {
        assertEquals(PermTestData.class.getName() + ".assertEquals failed compare perm objectName", objName, pOp.getObjectName());
        assertEquals(PermTestData.class.getName() + ".assertEquals failed compare perm operation name", getName(op), pOp.getOpName());
    ...
    {
        assertEquals(PermTestData.class.getName() + ".assertEquals failed compare perm objectName", getName(obj), pObj.getObjectName());
        assertEquals(PermTestData.class.getName() + ".assertEquals failed compare perm description", getDescription(obj), pObj.getDescription());

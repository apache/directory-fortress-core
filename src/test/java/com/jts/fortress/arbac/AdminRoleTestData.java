...
class AdminRoleTestData extends TestCase
{
    ...
    /**
      * Test Case TR1:
     */
    final static String[][] AROLES_TR1 = {
        {
            "oamAdmin1",                  /* NAME_COL */
    ...
    final static String[][] AROLES_TR2 = {
        {
    ...
    final static String[][] AROLES_TR3 = {
        {
            "T3AdmRle1",                  /* NAME_COL */
    ...
    final static String[][] AROLES_TR3_UPD = {
        {
            "T3AdmRle1",                  /* NAME_COL */
    ...
    final static String[][] AROLES_TR4_ASC = {
        {
            "T4AdmRle1",                  /* NAME_COL */
    ...
    final static String[][] AROLES_TR5_DSC = {
        {
            "T5AdmRle1",                  /* NAME_COL */
    ...
    final static String[][] AROLES_TR6_HIER = {
        {
            "T6AdmRle1",                  /* NAME_COL */
    ...
    */
    ...
    public static boolean isBeginInclusive(String[] rle)
    {
        ...
        if(com.jts.fortress.util.attr.VUtil.isNotNullOrEmpty(rle[IS_BEGIN_INCLUSIVE]) && rle[IS_BEGIN_INCLUSIVE].equalsIgnoreCase("T"))
        {
            result = true;
        }
    ...
    public static com.jts.fortress.arbac.AdminRole getRole(String[] rle)
    {
        com.jts.fortress.arbac.AdminRole role = (com.jts.fortress.arbac.AdminRole)getRoleConstraint(rle);
    ...
    public static com.jts.fortress.util.time.Constraint getRoleConstraint(String[] rle)
    {

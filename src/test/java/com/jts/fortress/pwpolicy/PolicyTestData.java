...
public class PolicyTestData extends TestCase
{
     ...
     */
    final protected static Logger log = Logger.getLogger(PolicyTestData.class.getName());
     ...
     * @param plcy
     */
    public static void assertEquals(PswdPolicy policy, String[] plcy)
    {
        assertEquals(PolicyTestData.class.getName() + ".assertEquals failed compare policy name", getName(plcy), policy.getName());
        ...
        assertEquals(PolicyTestData.class.getName() + ".assertEquals failed compare policy minAge", getMinAge(plcy), policy.getMinAge());
        assertEquals(PolicyTestData.class.getName() + ".assertEquals failed compare policy maxAge", getMaxAge(plcy), policy.getMaxAge());
        assertEquals(PolicyTestData.class.getName() + ".assertEquals failed compare policy inHistory", getInHistory(plcy), policy.getInHistory());
        assertEquals(PolicyTestData.class.getName() + ".assertEquals failed compare policy ", getCheckQuality(plcy), policy.getCheckQuality());
        assertEquals(PolicyTestData.class.getName() + ".assertEquals failed compare policy minLength", getMinLength(plcy), policy.getMinLength());
        assertEquals(PolicyTestData.class.getName() + ".assertEquals failed compare policy expireWarning", getExpireWarning(plcy), policy.getExpireWarning());
        assertEquals(PolicyTestData.class.getName() + ".assertEquals failed compare policy graceLoginLimit", getGraceLoginLimit(plcy), policy.getGraceLoginLimit());
        assertEquals(PolicyTestData.class.getName() + ".assertEquals failed compare policy lockout", getLockout(plcy), policy.getLockout());
        assertEquals(PolicyTestData.class.getName() + ".assertEquals failed compare policy lockoutDuration", getLockoutDuration(plcy), policy.getLockoutDuration());
        assertEquals(PolicyTestData.class.getName() + ".assertEquals failed compare policy maxFailure", getMaxFailure(plcy), policy.getMaxFailure());
        assertEquals(PolicyTestData.class.getName() + ".assertEquals failed compare policy failureCountInterval", getFailureCountInterval(plcy), policy.getFailureCountInterval());
     ...
     * @return
     */
    public static com.jts.fortress.pwpolicy.PswdPolicy getPolicy(String[] plcy)
    {

...
public class RoleTestData extends TestCase
{
    ...
    final static String[][] ROLES_TR4_UPD = {
        {
            "oamT4ROLE1",      /* NAME_COL */
    ...
    final static String[][] ROLES_TR5_HIER = {
        {
            "oamT5ROLE1",      /* NAME_COL */
    ...
    final static String[][] ROLES_TR5B = {
        {
    ...
    final static String[][] ROLES_TR9_SSD = {
        {
            "oamT9SSDR1",      /* NAME_COL */
    ...
    final static String[][] ROLES_TR10_SSD = {
        {
    ...
    final static String[][] ROLES_TR11_DESC_SSD = {
         {
             "oamT11SSD1",                              /* NAME_COL */
    ...
    final static String[][] ROLES_TR12_DESC_SSD = {
         {
             "oamT12SSD1",                              /* NAME_COL */
    ...
    final static String[][] ROLES_TR13_DESC_SSD = {
         {
             "oamT13SSD1",                              /* NAME_COL */
    ...
    final static String[][] ROLES_TR8_DSD = {
         {
             "oamDSDR1",        /* NAME_COL */
             "Test Case TR8",   /* DESC_COL */
             "30",              /* TIMEOUT_COL */
     ...
     final static String[][] ROLES_TR9_DSD = {
         {
             "oamT9DSDR1",      /* NAME_COL */
             "Test Case TR9",   /* DESC_COL */
             "30",              /* TIMEOUT_COL */
     ...
     final static String[][] ROLES_TR10_DSD = {
         {
     ...
     final static String[][] ROLES_TR11_DESC_DSD = {
          {
              "oamT11DSD1",                              /* NAME_COL */
              "Test Case TR11",                          /* DESC_COL */
              "30",                                      /* TIMEOUT_COL */
     ...
     final static String[][] ROLES_TR12_DESC_DSD = {
          {
              "oamT12DSD1",                              /* NAME_COL */
              "Test Case TR12",                          /* DESC_COL */
              "30",                                      /* TIMEOUT_COL */
     ...
     final static String[][] ROLES_TR13_DESC_DSD = {
          {
              "oamT13DSD1",                              /* NAME_COL */
              "Test Case TR13",                          /* DESC_COL */
              "30",                                      /* TIMEOUT_COL */
    ...
    final static String[][] ROLES_TR16_SD = {
        {
            "oamT16SDR1",      /* NAME_COL */
    ...
    {
        com.jts.fortress.util.time.Constraint validConstraint = RoleTestData.getRoleConstraint(rle);
    ...
    {
        com.jts.fortress.util.time.Constraint validConstraint = RoleTestData.getRoleConstraint(urle);

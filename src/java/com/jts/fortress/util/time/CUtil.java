...
public class CUtil
{
     ...
     * @throws com.jts.fortress.ValidationException on first invalid attribute found.
     */
    ...
    {
        /**
         * Specifies {@link com.jts.fortress.rbac.User}
         */
        USER,
        /**
         * Specifies {@link com.jts.fortress.rbac.Role}
         */
        ROLE
    }
     ...
     * targeted entity.  If a particular {@link com.jts.fortress.rbac.UserRole} violates constraint it will not be activated.  If {@link com.jts.fortress.rbac.User} validation fails a ValidationException will be thrown thus preventing User logon.
     *

 ...
 * For example, this entity requires {@link #objectName} and {@link #ou} attributes set before passing into {@link com.jts.fortress.rbac.AdminMgrImpl} or  {@link com.jts.fortress.rbac.ReviewMgrImpl} APIs.
 ...
 * <ul>
 * <li>{@link #setObjectName} and {@link #setOu} attributes set before calling {@link com.jts.fortress.rbac.AdminMgrImpl#addPermObj(PermObj)}.
 * <li>{@link #addProperty} may be set before calling {@link com.jts.fortress.rbac.AdminMgrImpl#addPermObj(PermObj)}.
 * <li>{@link #getProperty} may be set after calling {@link com.jts.fortress.rbac.ReviewMgrImpl#findPermObjs(PermObj)}.
 * </ul>
 * <p/>

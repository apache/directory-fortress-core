 ...
 * The UserRole entity carries elements of {@link com.jts.fortress.util.time.Constraint}.  Any attributes of Constraint not set within this entity
 * will use same attribute from the {@link com.jts.fortress.rbac.Role} entity.  Thus the UserRole can override Constraint attributes from it's corresponding Role if required by caller.
 * <p/>

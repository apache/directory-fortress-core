 ...
 * </ul>
 * <p/>
 * For certain APIs, i.e., {@link com.jts.fortress.AccessMgr#createSession(com.jts.fortress.rbac.User, boolean)}, or {@link com.jts.fortress.AccessMgr#authenticate(String, String)}, the caller may need to differentiate by one of the above subclasses, e.g. {@link PasswordException}, to facilitate password expiring condition or allow user to retry authentication after entering it incorrectly.

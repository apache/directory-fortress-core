 ...
 * Some of the values for public constants defined here must be known to end users of system to declare system cfg parameters, see {@link us.jts.fortress.cfg.Config}.
...
public class GlobalIds
{
    ...
    /**
     * When this optional tag, {@code accessmgr.implementation}, is placed in Fortress properties, its class name will be the default {@link us.jts.fortress.AccessMgr} instance used.
     */
    ...
    /**
     * When this optional tag, {@code auditmgr.implementation}, is placed in Fortress properties, its class name will be the default {@link us.jts.fortress.AuditMgr} instance used.
     */

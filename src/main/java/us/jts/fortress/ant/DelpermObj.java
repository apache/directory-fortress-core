...
/**
 * The class is used by {@link FortressAntTask} to load {@link PermObj}s used to drive {@link us.jts.fortress.AdminMgr#deletePermObj(us.jts.fortress.rbac.PermObj)}.
...
public class DelpermObj
{
     ...
     *
     * @return collection containing {@link us.jts.fortress.rbac.PermObj}s targeted for deletion.
     */

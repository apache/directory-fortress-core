...
/**
 * The class is used by {@link FortressAntTask} to load {@link us.jts.fortress.rbac.UserRole}s used to drive {@link us.jts.fortress.AdminMgr#deassignUser(us.jts.fortress.rbac.UserRole)}.
...
public class Deluserrole
{
     ...
     *
     * @return collection containing {@link us.jts.fortress.rbac.UserRole}s targeted for removal.
     */

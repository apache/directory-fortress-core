...
public class FortressAntTask extends Task implements InputHandler
{
    ...
    final private List<us.jts.fortress.ant.Addconfig> addconfig = new ArrayList<us.jts.fortress.ant.Addconfig>();
    final private List<us.jts.fortress.ant.Delconfig> delconfig = new ArrayList<us.jts.fortress.ant.Delconfig>();
    ...
    final private List<Addrole> addroles = new ArrayList<us.jts.fortress.ant.Addrole>();
    ...
    final private List<Addadminrole> addadminroles = new ArrayList<us.jts.fortress.ant.Addadminrole>();

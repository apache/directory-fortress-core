...
/**
 * This exception is declared to be thrown by all APIs within Fortress Manager interfaces: ({@link us.jts.fortress.AdminMgr}, {@link us.jts.fortress.AccessMgr},
 * {@link us.jts.fortress.ReviewMgr},{@link PwPolicyMgr},{@link us.jts.fortress.AuditMgr},{@link DelAdminMgr},
 * {@link DelAccessMgr},{@link DelReviewMgr},{@link us.jts.fortress.cfg.ConfigMgr}).
 * <h3>
 ...
 * </ul>
 * <p/>
 * For certain APIs, i.e., {@link us.jts.fortress.AccessMgr#createSession(us.jts.fortress.rbac.User, boolean)}, or {@link us.jts.fortress.AccessMgr#authenticate(String, char[])}, the caller may need to differentiate by one of the above subclasses, e.g. {@link PasswordException}, to facilitate password expiring condition or allow user to retry authentication after entering it incorrectly.
 ...
 * <p/>
 * All exceptions generated by Fortress will be set with error code {@link us.jts.fortress.SecurityException#getErrorId()} indicating fault condition which is set via its constructor - ({@link #SecurityException(int, String)}, {@link #SecurityException(int, String, Exception)}).

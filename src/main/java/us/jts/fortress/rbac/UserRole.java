 ...
 * The UserRole entity carries elements of {@link us.jts.fortress.util.time.Constraint}.  Any attributes of
 * Constraint not set within this entity
 * will use same attribute from the {@link us.jts.fortress.rbac.Role} entity.  Thus the UserRole can override

...
/**
 * This entity is used to pass search criteria into the {@link us.jts.fortress.AuditMgr} APIs, down through the
...
public class UserAudit extends FortEntity implements java.io.Serializable
{
    ...
    /**
     * Get the optional userId attribute which limits set by {@link us.jts.fortress.rbac.User#userId}.
    ...
    /**
     * Set the optional userId attribute which limits set by {@link us.jts.fortress.rbac.User#userId}.
     * For authentication searchs, this attr maps to {@link AuditDAO#REQDN}.  For authorization search, it will map to {@link AuditDAO#REQUAUTHZID}.
     * The userId for this search represents the end user.
     *
    ...
    /**
     * Get the optional internalUserId attribute which limits set by {@link us.jts.fortress.rbac.User#internalId}.
    ...
    /**
     * Set the optional internalUserId attribute which limits set by {@link us.jts.fortress.rbac.User#internalId}.
     * For {@link AuditMgrImpl#searchUserSessions(UserAudit)} this attr maps to {@link AuditDAO#REQMOD}.
     * The internalUserId for this search represents the end user but is stored as its internal id.
     *

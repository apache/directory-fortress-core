 ...
 */
public abstract class Manageable implements us.jts.fortress.Manageable
{
     ...
     */
    protected final void setEntitySession(String className, String opName, FortEntity entity) throws us.jts.fortress.SecurityException
    {

...
public final class AcceleratorDAO extends ApacheDsDataProvider implements us.jts.fortress.rbac.dao.AcceleratorDAO

{
    ...
    public final Session createSession( User user ) throws SecurityException
    {
        ...
        try
        {
            ...
            else
            {
                ...
                throw new us.jts.fortress.SecurityException( GlobalErrIds.USER_PW_INVLD, info );
            }
        }
        catch ( LdapException e )
        {
            String error = "createSession userId [" + user.getUserId() + "] caught LDAPException=" + " msg=" + e
                .getMessage();
            throw new us.jts.fortress.SecurityException( GlobalErrIds.ACEL_CREATE_SESSION_ERR, error, e );
        }
        finally
        {
     ...
     * @param perm  must contain the object, {@link us.jts.fortress.rbac.Permission#objName}, and operation, {@link us.jts.fortress.rbac.Permission#opName}, of permission User is trying to access.
        ...
        throws SecurityException
    {
        ...
        catch ( LdapException e )
        {
            String error = "checkAccess perm obj [" + perm.getObjName() + "], operation [" + perm.getOpName() + "] caught LDAPException=" + " msg=" + e
                .getMessage();
            throw new us.jts.fortress.SecurityException( GlobalErrIds.ACEL_CHECK_ACCESS_ERR, error, e );
        }
        finally
        {
            closeAdminConnection( ld );
    ...
    public void dropActiveRole( Session session, UserRole userRole ) throws SecurityException
    {
        ...
        try
        {
            ...
            if(rbacDropRoleResponse.getLdapResult().getResultCode().getResultCode() != 0)
            {
                ...
                throw new us.jts.fortress.SecurityException( GlobalErrIds.URLE_NOT_ACTIVE, info );
            }
        }
        catch ( LdapException e )
        {
            String error = "dropActiveRole role name [" + userRole.getName() + "] caught LDAPException=" + " msg=" + e
                .getMessage();
            throw new us.jts.fortress.SecurityException( GlobalErrIds.ACEL_DROP_ROLE_ERR, error, e );
        }
        finally
        {
            closeAdminConnection( ld );
    ...
    public void addActiveRole( Session session, UserRole userRole ) throws SecurityException
    {
        ...
        try
        {
            ...
            if(rbacAddRoleResponse.getLdapResult().getResultCode().getResultCode() != 0)
            {
                ...
                throw new us.jts.fortress.SecurityException( rc, info );
            }
        }
        catch ( LdapException e )
        {
            String error = "addActiveRole role name [" + userRole.getName() + "] caught LDAPException=" + " msg=" + e
                .getMessage();
            throw new us.jts.fortress.SecurityException( GlobalErrIds.ACEL_ADD_ROLE_ERR, error, e );
        }
        finally
        {
            closeAdminConnection( ld );
    ...
    public void deleteSession( Session session ) throws SecurityException
    {
        ...
        catch ( LdapException e )
        {
            String error = "deleteSession caught LDAPException=" + " msg=" + e
                .getMessage();
            throw new us.jts.fortress.SecurityException( GlobalErrIds.ACEL_DELETE_SESSION_ERR, error, e );
        }
        finally
        {
            closeAdminConnection( ld );

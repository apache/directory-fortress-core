...
public class AuthZ extends FortEntity implements Serializable
{
     ...
     * The config property name {@link us.jts.fortress.ldap.PoolMgr#LDAP_LOG_POOL_UID} contains the audit log system user id.
     *
     ...
     * For Fortress bind operations this will map to {@link us.jts.fortress.rbac.User#userId}
     *

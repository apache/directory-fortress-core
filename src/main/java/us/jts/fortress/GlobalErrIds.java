 ...
 * <li>{@link us.jts.fortress.CreateException} in the event DAO cannot create entity.
 * <li>{@link us.jts.fortress.FinderException} in the event DAO cannot find the entity.
 * <li>{@link us.jts.fortress.PasswordException} in the event user fails password checks.
 * <li>{@link us.jts.fortress.RemoveException} in the event DAO cannot remove entity.
 * <li>{@link us.jts.fortress.SecurityException} in the event security check fails.
 * <li>{@link us.jts.fortress.UpdateException} in the event DAO cannot update entity.
 * <li>{@link us.jts.fortress.ValidationException} in the event entity validation fails.
 * </ul>
 * <p/>
 * All Fortress public Manager Impl APIs will throw exception derived from {@link us.jts.fortress.SecurityException} and containing
...
public class GlobalErrIds
{
    ...
    /**
     * The supplied {@link us.jts.fortress.rbac.OrgUnit#type} is required and cannot be null.
     */

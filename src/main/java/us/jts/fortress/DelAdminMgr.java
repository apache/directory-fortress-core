...
public interface DelAdminMgr extends Manageable
{
     ...
     * </ul>
     *
     * @param uAdminRole entity contains {@link us.jts.fortress.rbac.User#userId} and {@link us.jts.fortress.rbac.AdminRole#name} and optional {@code Constraints}..
     * @throws us.jts.fortress.SecurityException
     ...
     * <h4>required parameters</h4>
     * <ul>
     * <li>child - {@link us.jts.fortress.rbac.OrgUnit#name} - contains the name of existing OrgUnit to be parent</li>
     ...
     * <li>parent - {@link us.jts.fortress.rbac.OrgUnit#name} - contains the name of new OrgUnit to be child</li>
     * </ul>
     * <h4>optional parameters child</h4>
     * <ul>
     ...
     * <h4>required parameters</h4>
     * <ul>
     * <li>{@link us.jts.fortress.rbac.PermObj#objectName} - contains the name of existing object being updated</li>
     * </ul>
     * <h4>optional parameters</h4>
     * <ul>
     * <li>{@link us.jts.fortress.rbac.PermObj#ou} - contains the name of an existing PERMS OrgUnit this object is associated with</li>
     ...
     * </ul>
     *
     * @param pObj must contain the {@link us.jts.fortress.rbac.PermObj#objectName}. Only non-null attributes will be updated.

...
/**
 * This class performs date validation for {@link us.jts.fortress.util.time.Constraint}.  This validator will ensure the current date falls between {@link us.jts.fortress.util.time.Constraint#getBeginDate()} and {@link us.jts.fortress.util.time.Constraint#getEndDate()}
 * The format requires YYYYMMDD, i.e. 20110101 for January 1, 2011.  The constant {@link us.jts.fortress.GlobalIds#NONE} may be used to disable checks for a particular entity.
...
{
    /**
     * This method is called during entity activation, {@link us.jts.fortress.util.time.CUtil#validateConstraints} and ensures the current date is
     * between {@link us.jts.fortress.util.time.Constraint#getBeginDate()} and {@link us.jts.fortress.util.time.Constraint#getEndDate()}.
     *

...
public final class AdminMgrRestImpl extends Manageable implements AdminMgr
{
     ...
     * </ul>
     *
     * @param user User entity must contain {@link org.openldap.fortress.rbac.User#userId} and {@link org.openldap.fortress.rbac.User#ou} (required) and optional {@link org.openldap.fortress.rbac.User#description},{@link org.openldap.fortress.rbac.User#roles} and many others.
     ...
     * </ul>
     *
     * @param user entity contains {@link org.openldap.fortress.rbac.User#userId} of User to be unlocked.
     * @throws SecurityException will be thrown in the event of pw policy violation or system error.
     */
    @Override
     ...
     * </ul>
     *
     * @param role must contains {@link org.openldap.fortress.rbac.Role#name} (required) and optional {@link org.openldap.fortress.rbac.Role#description}.
     * @throws SecurityException Thrown in the event of data validation or system error.
     */
    @Override
     ...
     * A Fortress Permission instance exists in a hierarchical, one-many relationship between its parent and itself as stored in ldap tree: ({@link org.openldap.fortress.rbac.PermObj}*->{@link Permission}).
     * <h4>required parameters</h4>
     * <ul>
     ...
     * A {@link org.openldap.fortress.rbac.PermObj} instance exists in a hierarchical, one-many relationship between itself and children as stored in ldap tree: ({@link org.openldap.fortress.rbac.PermObj}*->{@link Permission}).
     * <h4>required parameters</h4>
     * <ul>

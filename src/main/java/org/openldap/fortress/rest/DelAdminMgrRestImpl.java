 ...
 */
public final class DelAdminMgrRestImpl extends org.openldap.fortress.rbac.Manageable implements DelAdminMgr
{
     ...
     * <h4>required parameters</h4>
     * <ul>
     * <li>{@link org.openldap.fortress.rbac.AdminRole#name} - contains the name of the new AdminRole being targeted for removal</li>
     * </ul>
     * <p/>
     *
     ...
     * <li>child - {@link org.openldap.fortress.rbac.OrgUnit#name} - contains the name of new OrgUnit to be child</li>
     * </ul>
     * <h4>optional parameters child</h4>
     * <ul>
     * <li>child - {@link org.openldap.fortress.rbac.OrgUnit#description} - maps to description attribute on organizationalUnit object class for new child</li>
     * </ul>
     *
     ...
     * </ul>
     *
     * @param perm must contain the object, {@link org.openldap.fortress.rbac.Permission#objName}, and operation, {@link org.openldap.fortress.rbac.Permission#opName}, that identifies target along with optional other attributes..
     ...
     * A {@link PermObj} instance exists in a hierarchical, one-many relationship between itself and children as stored in ldap tree: ({@link org.openldap.fortress.rbac.PermObj}*->{@link org.openldap.fortress.rbac.Permission}).
     * <h4>required parameters</h4>
     * <ul>

...
public class ConfigMgrRestImpl implements ConfigMgr
{
     ...
     */
    @Override
    public Properties add(String name, Properties inProperties) throws org.openldap.fortress.SecurityException
    {
     ...
     */
    @Override
    public Properties update(String name, Properties inProperties) throws org.openldap.fortress.SecurityException
    {
     ...
     */
    @Override
    public void delete(String name) throws org.openldap.fortress.SecurityException
    {

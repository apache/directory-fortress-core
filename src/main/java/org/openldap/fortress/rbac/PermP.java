...
import org.openldap.fortress.rbac.dao.PermDAO;
 ...
 * {@link org.openldap.fortress.rbac.PermObj} or {@link org.openldap.fortress.rbac.Permission}, validate its contents and forward on to it's corresponding DAO class {@link org.openldap.fortress.rbac.dao.PermDAO}.
 * <p>
...
public final class PermP
{
     ...
     * @param session This object must be instantiated by calling {@link AccessMgrImpl#createSession} method before passing into the method.  No variables need to be set by client after returned from createSession.
     * @return List<Permission> containing permissions (op, obj) active for user's session.
     * @throws org.openldap.fortress.SecurityException is thrown if runtime error occurs with system.
     */
     ...
     * @throws org.openldap.fortress.ValidationException in the event of data validation error.
     */

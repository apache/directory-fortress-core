...
/**
 * This utility wraps {@link HierUtil} methods to provide hierarchical functionality for the {@link org.openldap.fortress.rbac.AdminRole} data set.
 ...
 * <p/>
 * Static methods on this class are intended for use by other Fortress classes, i.e. {@link DelAdminMgrImpl} and {@link org.openldap.fortress.rbac.dao.PermDAO}
...
public final class AdminRoleUtil
{
    ...
    /**
     * Used to determine if one {@link org.openldap.fortress.rbac.AdminRole} is the parent of another.  This method
     ...
     *
     * @param child maps to logical {@link org.openldap.fortress.rbac.AdminRole#name} on 'ftRls' object class.
     * @param parent maps to logical {@link org.openldap.fortress.rbac.AdminRole#name} on 'ftRls' object class.
    ...
    /**
     * Recursively traverse the {@link org.openldap.fortress.rbac.AdminRole} graph and return all of the descendants of a given parent {@link org.openldap.fortress.rbac.AdminRole#name}.
     * @param roleName {@link org.openldap.fortress.rbac.AdminRole#name} maps on 'ftRls' object class.
     * @param contextId maps to sub-tree in DIT, for example ou=contextId, dc=jts, dc = com.
     * @return Set of AdminRole names are children {@link org.openldap.fortress.rbac.AdminRole}s of given parent.
     */
     ...
     * @param roleName maps to logical {@link org.openldap.fortress.rbac.AdminRole#name} on 'ftRls' object class.
     * @param contextId maps to sub-tree in DIT, for example ou=contextId, dc=jts, dc = com.
    ...
    /**
     * Traverse one level of the {@link org.openldap.fortress.rbac.AdminRole} graph and return all of the parents (direct ascendants) of a given parent {@link org.openldap.fortress.rbac.AdminRole#name}.
     * @param roleName {@link org.openldap.fortress.rbac.AdminRole#name} maps on 'ftRls' object class.
     * @param contextId maps to sub-tree in DIT, for example ou=contextId, dc=jts, dc = com.
     * @return Set of AdminRole names are parents {@link org.openldap.fortress.rbac.AdminRole}s of given child.
     */
    ...
    /**
     * Return Set of {@link org.openldap.fortress.rbac.AdminRole#name}s ascendants.  Used by {@link org.openldap.fortress.rbac.dao.PermDAO#checkPermission}
     * for computing authorized {@link org.openldap.fortress.rbac.UserAdminRole#name}s.
     * @param uRoles contains list of adminRoles activated within a {@link org.openldap.fortress.rbac.User}'s {@link org.openldap.fortress.rbac.Session}.
     * @param contextId maps to sub-tree in DIT, for example ou=contextId, dc=jts, dc = com.
     ...
     *
     * @param childRole contains {@link org.openldap.fortress.rbac.AdminRole#name} of child.
     * @param parentRole contains {@link org.openldap.fortress.rbac.AdminRole#name} of parent.
     * @param mustExist boolean is used to specify if relationship must be true.
     * @throws org.openldap.fortress.ValidationException in the event it fails one of the 3 checks.
     */

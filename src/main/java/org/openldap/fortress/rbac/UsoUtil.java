...
/**
 * This utility wraps {@link HierUtil} methods to provide hierarchical functionality using the {@link org.openldap.fortress.rbac.OrgUnit} data set for User type {@link org.openldap.fortress.rbac.OrgUnit.Type#USER}.
...
public final class UsoUtil
{
     ...
     *
     * @param name {@link org.openldap.fortress.rbac.OrgUnit#name} on 'ftOrgUnit' object class.
    ...
    /**
     * Recursively traverse the {@link org.openldap.fortress.rbac.OrgUnit.Type#USER} graph and return number of children a given parent ou has.
     *
     * @param name maps to logical {@link org.openldap.fortress.rbac.OrgUnit#name} on 'ftOrgUnit' object class.
    ...
    /**
     * Return Set of {@link org.openldap.fortress.rbac.OrgUnit#name}s ascendants contained within {@link org.openldap.fortress.rbac.OrgUnit.Type#USER}.
     *

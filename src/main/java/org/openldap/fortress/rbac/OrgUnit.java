 ...
 * <h3>{@link org.openldap.fortress.rbac.User}*<->1 {@link OrgUnit}</h3>
 * <p/>
 * There is a Many-to-One relationship between a {@link org.openldap.fortress.rbac.PermObj} object and {@link OrgUnit}.
 * <h3>{@link org.openldap.fortress.rbac.PermObj}*<->1 {@link OrgUnit}</h3>
 * <p/>
    ...
    implements Graphable, java.io.Serializable
{
    ...
    {
        /**
         * Type {@link org.openldap.fortress.rbac.User} nodes reside in User OU pool.
         */
        USER,
        /**
         * Type {@link org.openldap.fortress.rbac.Permission} nodes reside in Perm OU pool.
         */
        PERM
    }

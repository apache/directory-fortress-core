...
public final class AdminMgrImpl extends Manageable implements AdminMgr
{
     ...
     * </ul>
     *
     * @param role must contains {@link Role#name} and may contain new description or {@link org.openldap.fortress.util
     * .time.Constraint}
     * @return Role contains reference to entity operated on.
     * @throws org.openldap.fortress.SecurityException
     ...
     * The perm operation entity may have {@link org.openldap.fortress.rbac.Role} or {@link org.openldap.fortress.rbac.User}
     ...
     * </ul>
     *
     * @param perm must contain the object, {@link org.openldap.fortress.rbac.Permission#objName}, and operation,
     ...
     * The perm operation entity may also contain {@link org.openldap.fortress.rbac.Role} or {@link org.openldap.fortress.rbac
     ...
     * </ul>
     *
     * @param pObj must contain the {@link PermObj#objName} and {@link PermObj#ou}.  The other attributes are
     *             optional.

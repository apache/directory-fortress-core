...
public final class DelAdminMgrImpl extends Manageable implements DelAdminMgr
{
     ...
     * </ul>
     *
     * @param uAdminRole entity contains {@link org.openldap.fortress.rbac.User#userId} and {@link org.openldap.fortress.rbac.AdminRole#name} and optional {@code org.openldap.fortress.rbac.Constraints}.
     ...
     * The perm operation entity may have {@link AdminRole} or {@link org.openldap.fortress.rbac.User} associations.  The target {@link Permission} must not exist prior to calling.
     ...
     * The perm operation entity may also contain {@link AdminRole} or {@link org.openldap.fortress.rbac.User} associations to add or remove using this function.

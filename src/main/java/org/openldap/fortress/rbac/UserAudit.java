...
/**
 * This entity is used to pass search criteria into the {@link org.openldap.fortress.AuditMgr} APIs, down through the
...
public class UserAudit extends FortEntity implements java.io.Serializable
{
    ...
    /**
     * Get the optional objName attribute which limits set by {@link org.openldap.fortress.rbac.Permission#objName}.
     ...
     * The object name is derived from another class name which represents targets for Fortress authorizations. For example {@link org.openldap.fortress.rbac.AdminMgrImpl} or 'CustomerCheckOutPage'.
     *
    ...
    /**
     * Set the optional objName attribute which limits set by {@link org.openldap.fortress.rbac.Permission#objName}.
     * For modification search, this attr maps to {@link AuditDAO#REQMOD}.  For authorization search, it will map to {@link AuditDAO#REQDN}.
     * The object name is derived from another class name which represents targets for Fortress authorizations. For example {@link org.openldap.fortress.rbac.AdminMgrImpl} or 'CustomerCheckOutPage'.
     *
    ...
    /**
     * Get the optional userId attribute which limits set by {@link org.openldap.fortress.rbac.User#userId}.
    ...
    /**
     * Set the optional userId attribute which limits set by {@link org.openldap.fortress.rbac.User#userId}.
     * For authentication searchs, this attr maps to {@link AuditDAO#REQDN}.  For authorization search, it will map to {@link AuditDAO#REQUAUTHZID}.
     * The userId for this search represents the end user.
     *
    ...
    /**
     * Get the optional internalUserId attribute which limits set by {@link org.openldap.fortress.rbac.User#internalId}.
    ...
    /**
     * Set the optional internalUserId attribute which limits set by {@link org.openldap.fortress.rbac.User#internalId}.
     * For {@link AuditMgrImpl#searchUserSessions(UserAudit)} this attr maps to {@link AuditDAO#REQMOD}.
     * The internalUserId for this search represents the end user but is stored as its internal id.
     *

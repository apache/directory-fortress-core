...
import org.openldap.fortress.rbac.dao.AcceleratorDAO;
...
public class AccelMgrImpl extends Manageable implements AccelMgr
{
    ...
    private static final AcceleratorDAO aDao = new org.openldap.fortress.rbac.dao.apache.AcceleratorDAO();


    /**
     * package private constructor ensures outside classes must use factory: {@link org.openldap.fortress.AccelMgrFactory}
     */
    public AccelMgrImpl()
    {
    }
     ...
     * <li> evaluate temporal {@link org.openldap.fortress.util.time.Constraint}(s) on {@link User}, {@link UserRole} and {@link UserAdminRole} entities.
     * <li> process selective role activations into User RBAC Session {@link User#roles}.
     * <li> check Dynamic Separation of Duties {@link DSDChecker#validate(Session, org.openldap.fortress.util.time.Constraint, org.openldap.fortress.util.time.Time)} on {@link User#roles}.

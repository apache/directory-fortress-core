...
/**
 * The class is used by {@link FortressAntTask} to load {@link ConfigAnt}s used to drive {@link org.openldap.fortress.cfg.ConfigMgr#delete(String, java.util.Properties)}.

...
import org.openldap.fortress.rbac.Hier;
 ...
 * Fortress DAO's, i.e. {@link org.openldap.fortress.rbac.dao.unboundid.UserDAO}. {@link org.openldap.fortress.rbac.dao.unboundid.RoleDAO}, {@link org.openldap.fortress.rbac.dao.unboundid.PermDAO}, ....
...
public abstract class UnboundIdDataProvider
{
    ...
    /**
     * Method wraps ldap client to return multi-occurring attribute values by name within a given entry and return as a list of type {@link org.openldap.fortress.rbac.Relationship}.
     *
     * @param entry         contains the target ldap entry.
     * @param attributeName name of ldap attribute to retrieve.
     * @return List of type {@link org.openldap.fortress.rbac.Relationship} containing parent-child relationships.
     * @throws LDAPException in the event of ldap client error.
     */
     ...
     * @param ftDateTime reference to {@link org.openldap.fortress.util.time.Constraint} containing formatted data.
     * @throws LDAPException in the event of ldap client error.
     */
    ...
    /**
     * Given a collection of {@link org.openldap.fortress.rbac.Relationship}, convert to raw data name-value format and load into ldap attribute set in preparation for ldap add.
     *
     * @param list     contains List of type {@link org.openldap.fortress.rbac.Relationship} targeted for adding to ldap.
     ...
     *
     * @param list     contains List of type {@link org.openldap.fortress.rbac.Relationship} targeted for updating in ldap.
     ...
     * @param op       specifies type of mod: {@link Hier.Op#ADD}, {@link org.openldap.fortress.rbac.Hier.Op#MOD}, {@link Hier.Op#REM}
     */

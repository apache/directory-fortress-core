 ...
 * the preferred cfg node by name via a property named, {@link com.jts.fortress.GlobalIds#CONFIG_REALM}.  Each
...
final class ConfigP
{
     ...
     * a {@link SecurityException} with error {@link com.jts.fortress.GlobalErrIds#FT_CONFIG_NOT_FOUND} will be thrown.
     *
     * @param name    attribute is required and maps to 'cn' attribute in 'device' object class.

...
public interface PwPolicyMgr extends Manageable
{
     ...
     * </ul>
     *
     * @param policy Object must contain {@link com.jts.fortress.rbac.PwPolicy#name} of the policy entity to remove.
     ...
     * <h4>required parameters</h4>
     * <ul>
     * <li>{@link com.jts.fortress.rbac.PwPolicy#name} - Maps to name attribute of pwdPolicy object class being read.</li>
     * </ul>
     *
     * @param name String contains the {@link com.jts.fortress.rbac.PwPolicy#name} of the policy entity to read.
     ...
     * @param policyName String contains the {@link com.jts.fortress.rbac.PwPolicy#name} of a pw policy entity contained within the PWPOLICIES data set.

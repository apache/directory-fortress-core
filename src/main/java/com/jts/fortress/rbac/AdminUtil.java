...
final class AdminUtil
{
    ...
    /**
     * Wrapper function to call {@link DelAccessMgrImpl#canAssign(com.jts.fortress.rbac.Session, com.jts.fortress.rbac.User, com.jts.fortress.rbac.Role)}.
    ...
    /**
     * Wrapper function to call {@link DelAccessMgrImpl#canDeassign(com.jts.fortress.rbac.Session, com.jts.fortress.rbac.User, com.jts.fortress.rbac.Role)}.
    ...
    /**
     * Wrapper function to call {@link DelAccessMgrImpl#canGrant(com.jts.fortress.rbac.Session, com.jts.fortress.rbac.Role, com.jts.fortress.rbac.Permission)}.
     ...
     * @param role    Instantiated Role entity requires only valid role name attribute set.
     * @param perm    Instantiated Permission entity requires {@link com.jts.fortress.rbac.Permission#objectName} and {@link com.jts.fortress.rbac.Permission#opName}.
     * @param contextId maps to sub-tree in DIT, for example ou=contextId, dc=jts, dc = com.
     ...
     */
    static void canGrant(Session session, Role role, Permission perm, String contextId) throws com.jts.fortress.SecurityException
    {
        if (session != null)
        {
            DelAccessMgr dAccessMgr = DelAccessMgrFactory.createInstance(contextId);
    ...
    /**
     * Wrapper function to call {@link DelAccessMgrImpl#canRevoke(com.jts.fortress.rbac.Session, com.jts.fortress.rbac.Role, com.jts.fortress.rbac.Permission)}.
     ...
     */
    static void canRevoke(Session session, Role role, Permission perm, String contextId) throws com.jts.fortress.SecurityException
    {
        if (session != null)
        {
            DelAccessMgr dAccessMgr = DelAccessMgrFactory.createInstance(contextId);
     ...
     */
    static void setEntitySession(Session session, Permission perm, FortEntity entity, String contextId) throws com.jts.fortress.SecurityException
    {
        if (session != null)
        {
     ...
     */
    static void checkAccess(Session session, Permission perm, String contextId) throws com.jts.fortress.SecurityException
    {
        if (session != null)
        {
            DelAccessMgr dAccessMgr = DelAccessMgrFactory.createInstance(contextId);

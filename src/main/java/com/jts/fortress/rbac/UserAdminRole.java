 ...
 * The UserAdminRole entity carries elements of {@link com.jts.fortress.util.time.Constraint}.  Any attributes of Constraint not set within this entity
...
public class UserAdminRole extends UserRole implements Administrator
{
     ...
     */
    public UserAdminRole(String userId, com.jts.fortress.util.time.Constraint con)
    {
        this.userId = userId;
        com.jts.fortress.util.time.CUtil.copy(con, this);
    }

 ...
 * </h4>
 * <ul>
 * <li>User Authentications:     <code>List<{@link Bind}>  {@link com.jts.fortress.AuditMgr#searchBinds(UserAudit)}</code>
 * <li>Invalid Users AuthN:      <code>List<{@link Bind}>  {@link com.jts.fortress.AuditMgr#searchInvalidUsers(UserAudit)} </code>
 * <li>User Authorizations 1:    <code>List<{@link AuthZ}> {@link com.jts.fortress.AuditMgr#getUserAuthZs(UserAudit)} </code>
 * <li>User Authorizations 2:    <code>List<{@link AuthZ}> {@link com.jts.fortress.AuditMgr#searchAuthZs(UserAudit)} </code>
 * <li>User Session Activations: <code>List<{@link Mod}>   {@link com.jts.fortress.AuditMgr#searchUserSessions(UserAudit)} </code>

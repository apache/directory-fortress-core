 ...
 * <li>Process layer:  {@link UserP}, {@link RoleP}, {@link com.jts.fortress.rbac.PermP},...</li>
 ...
 * For example, this entity requires {@link #setName} attribute set before passing into {@link com.jts.fortress.rbac.AdminMgrImpl} APIs.
 ...
 * <ul>
 * <li>{@link #setName} attribute must be set before calling {@link com.jts.fortress.rbac.AdminMgrImpl#addRole(Role)}, {@link com.jts.fortress.rbac.AdminMgrImpl#updateRole(Role)} or  {@link com.jts.fortress.rbac.AdminMgrImpl#deleteRole(Role)}
 * <li>{@link com.jts.fortress.util.time.Constraint} may be set <b>before</b> calling method {@link com.jts.fortress.rbac.AdminMgrImpl#addRole(Role)}.
 * <li>{@link com.jts.fortress.util.time.Constraint} will be <b>returned</b> to caller on methods like {@link com.jts.fortress.rbac.ReviewMgrImpl#readRole(Role)} or {@link com.jts.fortress.rbac.ReviewMgrImpl#findRoles(String)} iff persisted to entity prior to call.
 * </ul>
 * <p/>
 * This entity is used to store the RBAC Role assignments that comprise the many-to-many relationships between {@link User}s and {@link com.jts.fortress.rbac.Permission}s.
    ...
    implements Constraint, Graphable, java.io.Serializable
{
     ...
     */
    public Role(com.jts.fortress.util.time.Constraint con)
    {
        CUtil.copy(con, this);
    }

...
/**
 * Process module for Fortress hierarchical processing. The data sets affected include RBAC {@link com.jts.fortress.rbac.Role} and ARBAC {@link com.jts.fortress.rbac.AdminRole},{@link com.jts.fortress.rbac.OrgUnit}.
 * Each entry in the Hier data set contains a parent-child pairing that is read into graph using {@link HierUtil}.
 * The type of Hier entity is set via {@link com.jts.fortress.rbac.Hier.Type} which must be equal to one of the following: {@link com.jts.fortress.rbac.Hier.Type#ROLE},{@link com.jts.fortress.rbac.Hier.Type#AROLE}, {@link com.jts.fortress.rbac.Hier.Type#USER}, {@link com.jts.fortress.rbac.Hier.Type#PERM}.
 ...
 * {@link HierUtil},{@link RoleUtil},{@link AdminRoleUtil},{@link UsoUtil},{@link PsoUtil}
 * <p>
 * This class will accept Fortress entity, {@link Hier}, validate its contents and forward to DAO class {@link HierDAO}.
 * <p>
...
final class HierP
{
     ...
     *
     * @param hier contains {@link com.jts.fortress.rbac.Hier.Type#ROLE}, {@link com.jts.fortress.rbac.Hier.Type#AROLE}, {@link com.jts.fortress.rbac.Hier.Type#USER}, {@link com.jts.fortress.rbac.Hier.Type#PERM} which points to the target Hier data set.
     * @return Hier entity containing all attributes associated with Hier data set in directory.
     * @throws FinderException in the event DAO search error.                                                          N
     * @throws com.jts.fortress.ValidationException in the event input data fails validate checks.
     */
    final Hier read(Hier hier)
        throws FinderException, ValidationException
    {
        VUtil.assertNotNull(hier, GlobalErrIds.HIER_NULL, CLS_NM + ".read type=" + hier);
        VUtil.assertNotNull(hier, GlobalErrIds.HIER_TYPE_NULL, CLS_NM + ".read type=" + hier.getType());
        return hDao.getHier(hier);
    }

    /**
     * Adds a new Hierarchy node to directory. The Hier type enum will determine which type of data set insertion will
     * occur - {@link com.jts.fortress.rbac.Hier.Type#ROLE}, {@link com.jts.fortress.rbac.Hier.Type#AROLE}, {@link com.jts.fortress.rbac.Hier.Type#USER}, {@link com.jts.fortress.rbac.Hier.Type#PERM}.  The Hier entity input will be validated to ensure that:
     ...
     * occur {@link com.jts.fortress.rbac.Hier.Type#ROLE}, {@link com.jts.fortress.rbac.Hier.Type#AROLE}, {@link com.jts.fortress.rbac.Hier.Type#USER}, {@link com.jts.fortress.rbac.Hier.Type#PERM}.
     ...
     * @param op     specified what type of Hier update - {@link com.jts.fortress.rbac.Hier.Op#ADD},{@link com.jts.fortress.rbac.Hier.Op#MOD},{@link com.jts.fortress.rbac.Hier.Op#REM}
     ...
     * The SDSet type enum will determine where deletion will occur - {@link com.jts.fortress.rbac.Hier.Type#ROLE}, {@link com.jts.fortress.rbac.Hier.Type#AROLE}, {@link com.jts.fortress.rbac.Hier.Type#USER}, {@link com.jts.fortress.rbac.Hier.Type#PERM} data sets.
     * Hier entity must exist in directory prior to making this call else exception will be thrown.
     *
     * @param hier Contains the type name of the SDSet node targeted for deletion - {@link com.jts.fortress.rbac.Hier.Type#ROLE}, {@link com.jts.fortress.rbac.Hier.Type#AROLE}, {@link com.jts.fortress.rbac.Hier.Type#USER}, {@link com.jts.fortress.rbac.Hier.Type#PERM}.
     * @throws com.jts.fortress.SecurityException in the event of data validation or DAO system error.
     */

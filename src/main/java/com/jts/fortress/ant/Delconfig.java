...
/**
 * The class is used by {@link FortressAntTask} to load {@link ConfigAnt}s used to drive {@link com.jts.fortress.cfg.ConfigMgr#delete(String, java.util.Properties)}.

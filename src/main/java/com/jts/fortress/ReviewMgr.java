...
public interface ReviewMgr extends com.jts.fortress.Authorizable
{
     ...
     * @throws com.jts.fortress.SecurityException if permission not found or system error occurs.
     */
     ...
     * @throws com.jts.fortress.SecurityException In the event the role is not present in directory or system error occurs.
     */
     ...
     * @throws com.jts.fortress.SecurityException In the event system error occurs.
     */

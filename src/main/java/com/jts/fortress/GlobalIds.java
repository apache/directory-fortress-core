 ...
 * Some of the values for public constants defined here must be known to end users of system to declare system cfg parameters, see {@link com.jts.fortress.cfg.Config}.
...
public class GlobalIds
{
     ...
     */
    public final static boolean IS_REALM = GlobalIds.REALM_TYPE.equalsIgnoreCase(com.jts.fortress.cfg.Config.getProperty(GlobalIds.AUTHENTICATION_TYPE));
    ...
    */
     ...
     */
    public final static boolean OPENLDAP_IS_PW_POLICY_ENABLED = (com.jts.fortress.cfg.Config.getProperty(GlobalIds.OPENLDAP_PW_POLICY_IMPL) != null && (Config.getProperty(GlobalIds.OPENLDAP_PW_POLICY_IMPL)).equalsIgnoreCase(GlobalIds.OPENLDAP_PW_POLICY));
    ...
    */
     ...
     */
    public final static boolean LDAP_FILTER_SIZE_FOUND = (com.jts.fortress.cfg.Config.getProperty(LDAP_FILTER_SIZE_PROP) != null);
    ...
    static
    {
        try
        {
            String lenProp = com.jts.fortress.cfg.Config.getProperty(LDAP_FILTER_SIZE_PROP);

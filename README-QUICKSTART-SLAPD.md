...
# OpenLDAP & Fortress QUICKSTART
 ...
 Apache Fortress 2.0.1 and OpenLDAP Quickstart System Architecture
 ...
 * This document contains instructions to install Apache Fortress 2.0.1 Core, Web, Rest and OpenLDAP.
...
1. Download the package:
 ...
 ```
 wget http://www.apache.org/dist/directory/fortress/dist/2.0.1/fortress-core-2.0.1-source-release.zip
 unzip fortress-core-2.0.1-source-release.zip
 cd fortress-core-2.0.1
 ```
...
2. Download the fortress realm proxy jar into tomcat/lib folder:
  ...
  ```
  sudo wget http://repo.maven.apache.org/maven2/org/apache/directory/fortress/fortress-realm-proxy/2.0.1/fortress-realm-proxy-2.0.1.jar -P /usr/local/tomcat8/lib
  ```
...
1. Download the package:
 ...
 unzip fortress-rest-2.0.1-source-release.zip
